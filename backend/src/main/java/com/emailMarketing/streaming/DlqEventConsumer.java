...
import org.springframework.kafka.annotation.KafkaListener; import org.slf4j.Logger; import org.slf4j.LoggerFactory;
...
public class DlqEventConsumer {
    ...
    public void onDlq(Object payload){
        log.error("DLQ event captured class={} payload={}", payload==null?"null":payload.getClass().getSimpleName(), payload);

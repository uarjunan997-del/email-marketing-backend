...
public class PlanAccessAspect {
    ...
    @Before("@within(com.emailMarketing.security.RequiresPaidPlan) || @annotation(com.emailMarketing.security.RequiresPaidPlan) || @within(com.emailMarketing.security.RequiresPlan) || @annotation(com.emailMarketing.security.RequiresPlan)")
